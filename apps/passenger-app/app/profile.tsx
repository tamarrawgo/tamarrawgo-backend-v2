      ...
      <ScrollView contentContainerStyle={styles.content}>
        ...
        <View style={styles.section}>
          ...
          <TouchableOpacity style={styles.row} onPress={() => router.push('/history')}>
            ...
            <Text style={styles.rowLabel}>Ride History</Text>
            <Ionicons name="chevron-forward" size={18} color="#ccc" />
          </TouchableOpacity>
          <TouchableOpacity style={styles.row} onPress={() => router.push('/support')}>
            <Ionicons name="help-circle-outline" size={20} color="#FF6B00" />
...
const styles = StyleSheet.create({
  ...
  avatar: {
    width: 96, height: 96, borderRadius: 48, backgroundColor: '#FFF3EC',
    alignItems: 'center', justifyContent: 'center', marginBottom: 12,
  },
  name: { fontSize: 22, fontWeight: '800', color: '#333', marginBottom: 4 },
  phone: { fontSize: 15, color: '#999', marginBottom: 32 },
